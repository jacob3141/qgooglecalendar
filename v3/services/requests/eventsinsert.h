...
class EventsInsert : public RequestOperation {
public:
    EventsInsert(RequestOperationDelegate *requestDelegate, QObject *parent = 0)
    ...
    QNetworkRequest networkRequest() {
        QNetworkRequest networkRequest;
        networkRequest.setUrl(QString("%1/calendars/%2/events")
                              .arg(baseUrl())
                              .arg(_calendarId));

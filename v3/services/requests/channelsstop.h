...
class ChannelsStop : public RequestOperation {
public:
    ChannelsStop(RequestOperationDelegate *requestDelegate, QObject *parent = 0)
    ...
    QNetworkRequest networkRequest() {
        QNetworkRequest networkRequest;
        networkRequest.setUrl(QString("%1/channels/stop")
                              .arg(baseUrl()));

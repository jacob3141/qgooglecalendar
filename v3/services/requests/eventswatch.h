...
class EventsWatch : public RequestOperation {
public:
    EventsWatch(RequestOperationDelegate *requestDelegate, QObject *parent = 0)
    ...
    QNetworkRequest networkRequest() {
        QNetworkRequest networkRequest;
        networkRequest.setUrl(QString("%1/calendars/%2/events/watch")
                              .arg(baseUrl())
                              .arg(_calendarId));

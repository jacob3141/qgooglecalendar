...
class CalendarsClear : public RequestOperation {
public:
    CalendarsClear(RequestOperationDelegate *requestDelegate, QObject *parent = 0)
    ...
    QNetworkRequest networkRequest() {
        QNetworkRequest networkRequest;
        networkRequest.setUrl(QString("%1/calendars/%2/clear")
                              .arg(baseUrl())
                              .arg(_calendarId));
